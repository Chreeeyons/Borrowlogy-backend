...
class ChemicalViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [AllowAny]  # Change to stricter permission if needed
    serializer_class = ChemicalSerializer   # <--- This line is mandatory!


    def get_serializer_context(self):
        # Pass request to serializer for access control if needed
        return {'request': self.request}

    # Custom GET endpoint to list chemicals with optional filtering by hazardous status
    ...
    # Custom POST endpoint to add or update chemical (upsert)
    ...
    def add_chemical(self, request):
        ...
        if not all([chemical_name, volume, volume_unit, brand_name]):
    ...
    # Custom PUT/PATCH endpoint to edit chemical
    ...
    # Custom DELETE endpoint to delete chemical
